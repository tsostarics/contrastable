...
Also good: "We sum code our variable (reference level -1, comparisons +1). All
contrasts are set using the contrastable package (Sostarics 2024)." (point here
is to remove ambiguity of "sum code" using the specific numbers)
...
God: "We use the contrastable package's `sum_code()` function (+1/-1, Sostarics 2024)."
